...
export class UserVerificationCodeTypeValueObject {
    private constructor(
        private readonly userVerificationCodeType: UserVerificationCodeTypeEnum,
    ) {}
    ...
    static create(
        ...
        | InvalidUserVerificationCodeTypeError {
        if (!this.validate(userVerificationCodeType))
            return new InvalidUserVerificationCodeTypeError();

        return new UserVerificationCodeTypeValueObject(
