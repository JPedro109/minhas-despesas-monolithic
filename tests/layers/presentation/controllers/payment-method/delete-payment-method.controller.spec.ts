...
const makeSut = (): {
    ...
    mockExecuteChargeToExpiredSubscriptionUseCase: jest.Mocked<IDeletePaymentMethodUseCase>
} => {
    const mockExecuteChargeToExpiredSubscriptionUseCase: jest.Mocked<IDeletePaymentMethodUseCase> = {
        execute: jest.fn()
    };
