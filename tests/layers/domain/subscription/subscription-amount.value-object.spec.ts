import { SubscriptionAmountValueObject, InvalidSubscriptionAmountError } from "@/layers/domain";
...
describe("Value Object - SubscriptionAmountValueObject", () => {
    ...
    test("Should create SubscriptionAmountValueObject", () => {
      ...
      const sut = SubscriptionAmountValueObject.create(expenseValue) as unknown as SubscriptionAmountValueObject;
