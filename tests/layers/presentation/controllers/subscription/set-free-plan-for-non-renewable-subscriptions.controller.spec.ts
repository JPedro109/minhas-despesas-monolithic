import { IGetActiveNonRenewableSubscriptionsUseCase, IManageSubscriptionRenewalUseCase } from "@/layers/application";
...
describe("Controller - ExecuteChargeToExpiredSubscriptionController", () => {
    ...
    test("Should not set free plan for non renewable subscriptions because exists a promise reject", async () => {
        ...
        jest.spyOn(mockManageSubscriptionRenewalUseCase, "execute").mockRejectedValueOnce(new Error());
