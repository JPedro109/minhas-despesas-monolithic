import { NotFoundError, GetUserSubscriptionUseCase } from "@/layers/application";
import {
...
describe("Use case - GetUserSubscriptionUseCase", () => {
    ...
    test("Should get user subscription successfully", async () => {
        ...
        const userId = "1";
        jest.spyOn(subscriptionRepositoryStub, "getActiveSubscriptionByUserId").mockResolvedValue(testSubscriptionEntityWithPlanDiamond());
