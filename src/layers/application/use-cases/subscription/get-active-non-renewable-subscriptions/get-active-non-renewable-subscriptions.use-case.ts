import {
    GetActiveNonRenewableSubscriptionsResponseDTO,
    IGetActiveNonRenewableSubscriptionsUseCase,
    IUnitOfWorkRepository,
} from "@/layers/application";

export class GetActiveNonRenewableSubscriptionsUseCase
    implements IGetActiveNonRenewableSubscriptionsUseCase
{
