import { PrismaSubscriptionRepositoryAdapter, DatabaseSQLHelper } from "@/layers/external";
...
describe("External - PrismaSubscriptionRepositoryAdapter", () => {
    ...
    describe("createSubscription", () => {
        test("Should create a new subscription", async () => {
            const sut = new PrismaSubscriptionRepositoryAdapter(databaseSQLHelper);
    ...
    describe("getActiveSubscriptionByUserId", () => {
        test("Should return null if no active subscription exists", async () => {
            ...
            const result = await sut.getActiveSubscriptionByUserId("ffffffff-ffff-ffff-ffff-ffffffffffff");
        ...
        test("Should return the active subscription for a user", async () => {
            ...
            const result = await sut.getActiveSubscriptionByUserId("00000000-0000-0000-0000-000000000000");
    ...
    describe("getActiveSubscriptionsByEndDate", () => {
        test("Should return an empty array if no subscriptions match the criteria", async () => {
            ...
            const result = await sut.getActiveSubscriptionsByEndDate(endDate, renewable);
    ...
    describe("updateSubscriptionById", () => {
        test("Should update the subscription by ID", async () => {
            ...
            const updatedSubscription = await sut.getActiveSubscriptionByUserId(subscription.userId);
