import { UserVerificationCodeTypeValueObject, UserVerificationCodeTypeEnum, InvalidUserVerificationCodeTypeError } from "@/layers/domain";
...
describe(("Value Object - UserVerificationCodeTypeValueObject"), () => {
	...
	test("Should not create UserVerificationCodeTypeValueObject, because user verification code type is empty" , () => {
		...
		const sut = UserVerificationCodeTypeValueObject.create(invalidUserVerificationCodeTypeName as UserVerificationCodeTypeEnum);
	...
	test("Should create UserVerificationCodeTypeValueObject" , () => {
		const userVerificationCodeTypeName = UserVerificationCodeTypeEnum.VerifyUserEmail;
