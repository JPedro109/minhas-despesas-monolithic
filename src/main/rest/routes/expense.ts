...
export default (router: Router): void => {
    router.post(
        ...
        RestAdapter.middleware(new AuthorizationUserActionMiddleware(getUserSubscriptionUseCase, "create:expense")),
    ...
    router.get(
        "/expenses",
        RestAdapter.middleware(authenticationUserMiddleware),
        RestAdapter.middleware(new AuthorizationUserActionMiddleware(getUserSubscriptionUseCase, "get:expense")),
