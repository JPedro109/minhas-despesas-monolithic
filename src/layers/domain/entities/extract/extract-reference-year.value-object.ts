...
export class ExtractReferenceYearValueObject {
    ...
    static create(referenceYear: number): ExtractReferenceYearValueObject | InvalidExtractReferenceYearError {
        if (!this.validate(referenceYear)) return new InvalidExtractReferenceYearError();
